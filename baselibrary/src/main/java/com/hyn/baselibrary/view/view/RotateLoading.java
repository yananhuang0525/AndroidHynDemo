package com.hyn.baselibrary.view.view;
...
//            color = typedArray.getColor(R.styleable.RotateLoading_loading_color, Color.parseColor("#AAAAAA"));
...
//        canvas.drawArc(shadowRectF, bottomDegree, arc, false, mPaint);
    ...
    private void startAnimator() {
        ...
        scaleXAnimator.setDuration(450);
        scaleXAnimator.setInterpolator(new LinearInterpolator());
        scaleYAnimator.setDuration(450);
